...
import com.example.messages.adapters.ChatAdapter;
import com.example.messages.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private String getReadableDateTime(Date date){
        return new SimpleDateFormat("MMMM dd, yyyyy = hh:mm a",
