...
import com.example.messages.adapters.RecentConversationAdapter;
import com.example.messages.databinding.ActivityMainBinding;
import com.example.messages.listeners.ConversionListener;
import com.example.messages.models.ChatMessage;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void getToken() {
        FirebaseMessaging.getInstance().getToken().addOnSuccessListener(this::updateToken); // what the fuck does this do
    }
    ...
    public void onConversionClickedListener(User user){
